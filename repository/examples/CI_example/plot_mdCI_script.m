...
% plot the datapoints
figure(1); hold off;
idx_out = CI.xyz.idx_out;
idx_in = ~idx_out;
plot3(pos(idx_in,1),pos(idx_in,2),pos(idx_in,3),'linestyle','none','marker','o','color','b'); hold on;
plot3(pos(idx_out,1),pos(idx_out,2),pos(idx_out,3),'linestyle','none','marker','o','color','r','markerface','r'); hold on;
