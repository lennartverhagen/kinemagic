function cfg_proc_GraspSlant
%--------------------------------------------------------------------------
% CFG_PROC_GRSAPSLANT is a wrapper function for kinematic data processing
% and analyses for the Grasping Slanted Objects experiment.
%
...
cdata('graspslant');
if ispc
    dir_root	= fullfile('M:\','Data','GraspSlant');
else
    dir_root	= fullfile(filesep,'home','action','lenver','Data','GraspSlant');
end
subjects	= {      '',      '',      '',      '',      '',...
...
switch lower(currsettask)
    ...
    case 'read'
        ...
        cfg.filter.ord          = 6;
        % grip
        cfg.grip.marker         = {{'t','i'},{'mti','o'}};
        cfg.grip.label          = {'gti','d2t'};
    ...
    case 'ana'
        ...
        cfg.movdef(1).gripvel.marker    = 'gti';
        ...
        % movement offset
        %cfg.movdef(2).feedback          = 'movplot';
        cfg.movdef(2).msi               = 'yes';
        cfg.movdef(2).twin              = 1;
        ...
        cfg.movdef(2).vel{2}.marker     = {'t','i','o'};
        ...
        cfg.movdef(2).gripapt{2}.marker	= 'gti';
        ...
        cfg.movdef(2).gripvel{1}.marker = 'gti';
        ...
        cfg.movdef(2).gripvel{1}.lookaround.twin	= [0 0.2];
        cfg.movdef(2).gripvel{1}.comb   = 'any';
        cfg.movdef(2).gripvel{2}.marker = 'gti';
        ...
        cfg.movdef(2).gripvel{3}.marker = 'gti';
        ...
        %cfg.movdef(2).gripacc.marker   = 'gti';
        ...
        cfg.movdef(2).probwin.paramidx  = [1 5];
        ...
        cfg.movcheck.peakvel.marker	= 'mti';
        ...
        cfg.movcheck.pos.refmarker  = 'o';
        cfg.movcheck.pos.crit       = '(z>-4*y) & (z<-0.5*y)';
        cfg.movcheck.pos.type       = 'excl';
        cfg.movcheck.bpos.marker    = 'mti';
        cfg.movcheck.bpos.refmarker = 'o';
        ...
        cfg.movplot.pos.marker      = 'mti';
        cfg.movplot.pos.axis        = 'z';
        cfg.movplot.vel.marker      = 'mti';
        cfg.movplot.vel.axis        = 'yz';
        cfg.movplot.gripapt.marker  = 'gti';
        ...
        cfg.trlcheck.bvel.marker	= 'mti';
        cfg.trlcheck.bvel.crit      = [-0.05 0.05];
        cfg.trlcheck.bpos.marker    = 'mti';
        cfg.trlcheck.bpos.refmarker = 'o';
        cfg.trlcheck.bpos.crit      = '(y<-0.15) & (z<-0.2)';
        cfg.trlcheck.bpos.type      = 'incl';
        % obtain movement parameters
        % FIXME: adapt parameter names to conventions described in km_movparam
        cfg.movparam.param          = {'rt','mt','mt_T','mt_A','rmt_T','rmt_A','tl','tl_T','tl_A','mv','mv_T','mv_A','pv','tpv','rtpv','pa','tpa','rtpa','pd','tpd','rtpd','nvc','nvc_T','nvc_A','pga','tpga','rtpga','gv_A','mgv_A','zgv_A','npgv_A','ga_A','ga_E','dga_A_Re','dga_E_Re','go_A','go_E','dgo_A_Re','dgo_E_Re','pos','zpos'};
        cfg.movparam.pos.marker     = 'mti';
        cfg.movparam.pos.axis       = {'x','y','z'};
        cfg.movparam.dist.marker    = 'mti';
        cfg.movparam.dist.axis      = 'yz';
        cfg.movparam.vel.marker     = 'mti';
        cfg.movparam.vel.axis       = 'yz';
        cfg.movparam.vel.T.marker   = 'j';
        cfg.movparam.vel.T.axis     = 'yz';
        cfg.movparam.vel.T.crit     = 0.3;
        cfg.movparam.vel.T.slide    = 0.03;
        cfg.movparam.vel.Tt.marker  = 't';
        cfg.movparam.vel.Tt.axis    = 'yz';
        cfg.movparam.vel.Tt.crit    = 0.3;
        cfg.movparam.vel.Tt.slide   = 0.03;
        cfg.movparam.vel.Ti.marker  = 'i';
        cfg.movparam.vel.Ti.axis    = 'yz';
        cfg.movparam.vel.Ti.crit    = 0.3;
        cfg.movparam.vel.Ti.slide   = 0.03;
        cfg.movparam.acc.marker     = 'mti';
        cfg.movparam.acc.axis       = 'yz';
        cfg.movparam.gripapt.marker	= 'gti';
        cfg.movparam.gripapt.axis	= 'yz';
        cfg.movparam.gripori.marker	= 'gti';
        cfg.movparam.gripori.axis   = 'yz';
        cfg.movparam.gripaptvel.marker	= 'gti';
        cfg.movparam.gripaptvel.axis	= 'yz';
        cfg.movparam.offset.E       = -0.05;
        cfg.movparam.offset.Rb      = [-0.2 -0.1];
        cfg.movparam.offset.Re      = [0.1 0.2];
    ...
    case 'trlrej'
        ...
        cfg.trlrej.apriori.param    = {'rt','mt','tl','mv','pv','pga','ga_E','dgo_E_Re'};
        cfg.trlrej.reportparam      = [{'apriori'} cfg.trlrej.apriori.param];
        % state cutoffs of apriori parameters
        cfg.trlrej.rt               = [0.3  1.5 ];
        cfg.trlrej.mt               = [0.4  2.0 ];
        cfg.trlrej.tl               = [0.35 0.6 ];
        cfg.trlrej.mv               = [0.15 1   ];
        cfg.trlrej.pv               = [0.5  2   ];
        cfg.trlrej.pga              = [0.08 0.16];
        cfg.trlrej.ga_E             = [0.08 0.11];
        cfg.trlrej.dgo_E_Re         = [-25  25  ];
    ...
    case 'ci'
        ...
        cfg.movparamCI.param        	= {'none'};
        cfg.movparamCI.trlrej.dataset	= 'MASKpchip_FILTlp15_MOV_ANA_IDXR';
        cfg.movparamCI.trlrej.listwise 	= {'apriori','rt','mt','tl','mv','pv','pga','ga_E','dgo_E_Re'};
        cfg.movparamCI.trlrej.pairwise 	= cfg.movparamCI.param;
        cfg.movparamCI.fact          	= {'slant','vision x slant'};
        cfg.movparamCI.lvl.slant    	= 0:15:90;
        ...
        cfg.eposerr.marker          = {'i','t','j','mti','o'};
        cfg.eposerr.axis            = 'xyz';
        cfg.eposerr.movname         = 'mov_T'; % FIXME: this does not work yet
