function [cfg,data] = km_readexpfun_kinematicTMSEEG(cfg,data)
%--------------------------------------------------------------------------
% KM_READEXPFUN_KINEMATICTMSEEG fills in experimentally specific fields in
...
% obj: object
if subjnr == 7
    data.label = {'w','t','i','MCP'};
elseif ismember(subjnr,8:10)
    data.label = {'MCP','t','i','obj'};
elseif ismember(subjnr,11:35)
    data.label = {'t','i','MCP','obj'};
else
